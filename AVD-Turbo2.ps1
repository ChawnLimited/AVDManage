...
# update Nuget
    ...
    catch {LogWrite ("101: Failed to add PSGallery as trusted repo. " + $_.Exception.Message); exit 102}
}
...
# Wait for the Azure Windows Guest Agent to startup
try {
	$d2=get-Date
	$dur=$d2-$d1
	...
	%{
		try {
			If ($HostPool) {
				...
				{LogWrite ("500: Remote Desktop Agents are already installed. Exit")
				exit 500}
				}
...
%{	
	try {$accessToken =(
		Invoke-RestMethod -Uri "http://169.254.169.254/metadata/identity/oauth2/token?api-version=2019-08-01&resource=$audience" -Headers @{Metadata="true"} -Method GET).access_token
		...
		catch{logwrite('800: Error connecting to Azure' +  $_.Exception.Message);exit 800}
}
$accessToken="null"
$response="null"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAvpDV28hTqGxIE
# rnIpOhQ/me2ehcIO23hKuPQosxrmh6CCIkEwggMwMIICtqADAgECAhA3dENPnrQO
...
# 9w0BCQQxIgQg23KI47XPHCzeDMaw9z/DPjmUuPck76WSnaKPMMzysAswCwYHKoZI
# zj0CAQUABGYwZAIwMAxFnzvEzLctMq4izvItq7YKQNjvcrAfouSwtehKI5yJ7dn3
# 3BXR6ZZhLfgtMqRnAjAUzmWBdfjXrViOknjE0B6EAgKRUyEHOXGs3dzdW4nxHYFN
# Nj1p1Wb13lANhaXBj0ChggMmMIIDIgYJKoZIhvcNAQkGMYIDEzCCAw8CAQEwfTBp
# MQswCQYDVQQGEwJVUzEXMBUGA1UEChMORGlnaUNlcnQsIEluYy4xQTA/BgNVBAMT
# OERpZ2lDZXJ0IFRydXN0ZWQgRzQgVGltZVN0YW1waW5nIFJTQTQwOTYgU0hBMjU2
# IDIwMjUgQ0ExAhAKgO8YS43xBYLRxHanlXRoMA0GCWCGSAFlAwQCAQUAoGkwGAYJ
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjUwOTIyMTcz
# NjM4WjAvBgkqhkiG9w0BCQQxIgQg0dJpM7NlTx0kWMzqCeVcXBCy/osGxHTaxJjh
# QD0azU8wDQYJKoZIhvcNAQEBBQAEggIAgvP1q6od42zPzFDaw/Jl+ZFzu1+kdMcW
# LehbPGBTHwREqGE/1STfKWK4wEK/pdnmT7diqmemZWPDD1i/ok+mHW11VONNaGTM
# RufHQZbnjzombvF5bnCoObnWPXf/NJdXGdQq3a1Zj06r34PDrENwWoNdYMM51qA+
# FIjYrg2dhAs9PhwhHycvaHiqw0aTPc/oKS9BcANzlCiUHVF6ft9h3xJL8iu8mayi
# sVtlsWBs4Ij/6Wuob53gPnDUSSKTOY3J81xguPc889P7MZYDKbDE9fbBHPeoy3dO
# IIACCjFKizWeWUD8/QisAGbDl0wUV4F1PxkAn6JxY2AeetZg0o9ner/i9GyLxyvS
# x3EqgnGDJvNSoEZM5VTAfqpd7P0gohOJrp9tRADhom7JRb/dk8hKxecoR4E6meja
# daP8S3xijKt7hQmH6AyCFDFJfqjTmJSAFmkh9Ih9p11J3lUc4q/YfWKyyLNx/UCg
# XrP5zAo4I3IRa99rbSpShjVsTMnP4Gmq1tldySjb8LGuv/x0u6VoqbLd5TBqL9if
# 32a9DVg6Fc3tNlpE4wJTAfjTyFo3B2lpojM/9jTUuQ6TjH0D40sjCKjkE1aUHEhl
# PTNN5sVbfe84mW2eEUHq8jt20PTiVYU2O9gR1FTcw433i2zZJaB86tIfTklnXj6K
# JNXeIn03CHA=
