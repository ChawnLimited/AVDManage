...
Function JoinDomain
{
	...
	try {
		if (-not $JOIN.HasSucceeded) {LogWrite ("Join Domain again.");$i=0; Do {start-sleep -Milliseconds 10; $i++} until ((Test-NetConnection -ComputerName $addomain -CommonTCPPort SMB -InformationLevel Quiet) -eq "True" -or $i -eq 10); if ($i -eq 10) {LogWrite ("Cannot connect to " + $ADDomain + ". Abort joining Active directory. Exit"); exit 302} else {LogWrite ($ADDomain + " is available after " + $i + " attempts.")}; $JOIN=Add-Computer -ComputerName . -DomainName $ADDomain -OUPath $ou -Credential $ADDomainCred -Options JoinWithNewName,AccountCreate -Force -Passthru -Verbose 4>&1 | Tee-Object -FilePath $LogFile -Append}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAhGjhewPTyWoCv
# +BAhGUnoSRoQ2wy6r8QEX391JkepdaCCIgswggMwMIICtqADAgECAhA3dENPnrQO
...
# IgQgFwYQO/HT2E/YRszTQcpsrrya/RHR83AweO2+oJ4595cwCwYHKoZIzj0CAQUA
# BGcwZQIwPkSSMRCMy0VPKefmJ4IbDzwgRQxziTyVhMlCEqevl8BncDcxIA5RH+fz
# a2Td116+AjEAsYxAcjiro+JfYnfJRHL4rob7b4TgUpPppyIQpPsSN8I9WSn3HPXV
# zfrUyCWYfianoYIDIzCCAx8GCSqGSIb3DQEJBjGCAxAwggMMAgEBMGowVTELMAkG
...
# BgkqhkiG9w0BCQUxDxcNMjYwMjI1MDU1NTM1WjA/BgkqhkiG9w0BCQQxMgQwEzYv
# sgsAZhfNX+5Ba59KEIusPEx1YRgWqvhdcr0n4pVcqpo/b2Gs4QzmAUAKSePPMA0G
# CSqGSIb3DQEBAQUABIICAEq3mCZBJpIjUdbt8XzU9/07qZZ2KyVTw49k1iwueV5i
# KW4hUir3dIazHmeeWxnw0XQaly5PrG6jJe4ax3Mqhy5ltabCWKqvb//Lu4el9MgB
# eYJKi5W0Qr2fzlcVRsHlM9RxIGMByoOF7DNkPF2muBGyMnBRNAroSGyWb/XlzN7O
# bD7yIJPqlvJmMIzkSihE7+0v6JrCd0j13aN7ZLz0tOp8i84cG5v3ap4vKdjiSV/y
# 6XYXuNzUmr2xYa56P4eEZn4UfzKA+J8XjWUblA4MqeVtmhBlpt2ic7JnqazSfn+O
# JAZu+eB5dgC0UZjHxVwtIB99eZAwojx9Co6gW63xtz4MS1J2UYOXpj07/xy7KWFw
# m3E3DcewY9ajRFa1Dq09oUGiESwdgVMHjhzY/3MFDi1/th1eNpyCuWilQmsV2Dnl
# ZYzMwWHMJAeo0aGgJvpd1QT1CXv5uc7GEaG0yy5aObmaR8RcLTKKEgI8BHklSKlo
# FL0jW9fZ4bozI96AOhRh4x22wEJ2GsuMFqIFxe0y254FuQZdesJzyEQbUKh7kt3A
# p/4pNkEbea4LLdj2xNvQAlrNi9wNgLbeLL7SOrKECxRZG1Bm6rJr+xzeoRTGwADf
# SZciZAwNXbGx/C2QI0AD3huIdq6cfYt7GJMBaV3pnVN6Eg//X4KBM5OcQXwboGDj
